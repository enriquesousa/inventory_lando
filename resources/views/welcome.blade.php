                ...
                <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <router-link class="collapse-item" to="/store-supplier">Añadir Proveedor</router-link>
                                <router-link class="collapse-item" to="/supplier">Lista Proveedores</router-link>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <router-link class="collapse-item" to="/store-product">Añadir Producto</router-link>
                                <router-link class="collapse-item" to="/product">Lista Productos</router-link>
                            </div>
                        </div>
                    </li>
