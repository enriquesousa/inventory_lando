                        ...
                        <div class="col-lg-12">
                            <div class="login-form">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Actualizar Proveedor</h1>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="email" class="form-control" id="email" placeholder="Correo Electrónico" v-model="form.email">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="empresa" placeholder="Nombre Empresa" v-model="form.shopname">
